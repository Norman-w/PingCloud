...
function defaults(id: number): Record<string, number> {
  ...
  const sets: Record<number, string[]> = {
    ...
    // 初学技巧 (drills, 3 indicators)
    40: ['手感','控制','稳定性'], 41: ['手感','控制','稳定性'], 42: ['手感','控制','稳定性'],
    43: ['手感','控制','弧线'], 44: ['柔韧','放松','感受'], 45: ['力量','耐力','感受'],
    46: ['引手','发力','弧线'], 47: ['等位','发力','时机'], 48: ['定肘','控制','稳定性'],
    49: ['跟球','落点','节奏'], 50: ['击球点','精准','时机'], 51: ['跟球','落点','节奏'],
    52: ['弧线','旋转','控制'], 53: ['跟球','弧线','节奏'], 54: ['防漏','发力','弧线'],
    55: ['翻挑','手感','时机'],
    // 身体协调和灵敏训练 (3-4 indicators)
    56: ['平衡','发力','落点'], 57: ['速度','灵敏','协调'],
    58: ['反应','判断','手感'], 59: ['引手','回收','协调'],
    // 基本功 — attack
    1:  ['速度','力量','落点','旋转'],           // 正手攻球
